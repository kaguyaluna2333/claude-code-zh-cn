...
[![macOS native](https://img.shields.io/badge/macos%20native-2.1.113--2.1.190%20experimental-yellow)](./docs/support-matrix.md)
...
| macOS / native binary | `experimental` | `2.1.113 - 2.1.190`（不含未纳入本轮支持的 `2.1.115`、`2.1.125`、`2.1.127`、`2.1.130`、`2.1.134`、`2.1.135`、`2.1.147`、`2.1.149`、`2.1.151`、`2.1.154`、`2.1.155`、`2.1.157`、`2.1.163`、`2.1.164`、`2.1.166`、`2.1.171`、`2.1.172`、`2.1.174`、`2.1.176`、`2.1.180`、`2.1.181`、`2.1.182`、`2.1.184`、`2.1.186`、`2.1.187`、`2.1.188`、`2.1.189`） | 当前 macOS arm64 native 已验证 extract / patch / repack / `--version` + 11 个稳定显示面审计；需要 `node-lief`；未验证新版本会安全跳过 CLI Patch |
...
| Claude Code native binary `2.1.113 - 2.1.190`（macOS arm64，不含未纳入本轮支持的 `2.1.115`、`2.1.125`、`2.1.127`、`2.1.130`、`2.1.134`、`2.1.135`、`2.1.147`、`2.1.149`、`2.1.151`、`2.1.154`、`2.1.155`、`2.1.157`、`2.1.163`、`2.1.164`、`2.1.166`、`2.1.171`、`2.1.172`、`2.1.174`、`2.1.176`、`2.1.180`、`2.1.181`、`2.1.182`、`2.1.184`、`2.1.186`、`2.1.187`、`2.1.188`、`2.1.189`） | 当前已验证的 native binary 版本，显示审计 11/11 PASS | `experimental`（需要 `node-lief`） |
...
- ✅ 在 macOS native experimental 已验证版本上 patch 硬编码文字（`2.1.113 - 2.1.114`、`2.1.116 - 2.1.124`、`2.1.126`、`2.1.128 - 2.1.129`、`2.1.131 - 2.1.133`、`2.1.136 - 2.1.146`、`2.1.148`、`2.1.150`、`2.1.152 - 2.1.153`、`2.1.156`、`2.1.158 - 2.1.162`、`2.1.165`、`2.1.167 - 2.1.170`、`2.1.173`、`2.1.175`、`2.1.177 - 2.1.179`、`2.1.183`、`2.1.185`、`2.1.190` 实测 1320-1473 处，显示审计 11/11 PASS）
